...
public class TravelCardAllhistoryAdapter extends RecyclerView.Adapter<TravelCardAllhistoryAdapter.MyViewHolder> {

    private int row_index;

    private List<TransactionAllListModal> alltransactionListModal_array;
    private Context context;
    private int rowLayout;
    private String TAG = "TravelCardhistoryAdapter";

    public TravelCardAllhistoryAdapter(List<TransactionAllListModal> alltransactionListModal_array, int rowLayout, Context context) {
    ...
    @Override
    public TravelCardAllhistoryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new TravelCardAllhistoryAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final TravelCardAllhistoryAdapter.MyViewHolder holder, final int position) {
