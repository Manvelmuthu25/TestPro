...
public class DirectionFloatingWidgetService extends Service implements View.OnClickListener {
    ...
    public DirectionFloatingWidgetService() {
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.close_floating_view:
                ...
                Intent intenti = new Intent(DirectionFloatingWidgetService.this, Home.class);
                intenti.putExtra("menuFragmentdirec", "direction");
      ...
      /*      case R.id.collapsed_iv:
                Intent intenti = new Intent(FloatingWidgetService.this, Home.class);
                startActivity(intenti);
                stopSelf();
                break;*/
        }
